...
namespace OxyPlot.Drawing
{
    ...
    public static class ConverterExtensions
    {
        ...
        */
        ...
        public static PointF ToPoint(this ScreenPoint pt, bool aliased)
        {
            ...
            if (aliased)
            {
                return new PointF((float)(0.5 + (int)pt.X), (float)(0.5 + (int)pt.Y));
            }
        ...
        public static RectangleF ToRect(this OxyRect r, bool aliased)
        {
            if (aliased)
            {
                ...
                return new RectangleF((float)x, (float)y, (float)(ri - x), (float)(bo - y));
            }
